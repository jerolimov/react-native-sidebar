...
import React, { Component, View, Animated, PanResponder, TouchableWithoutFeedback } from 'react-native';
...
export default class SidebarView extends Component {
	constructor(props) {
		...
		this.state = {
			open: props.open,
			contentWidth: 320, // will be changed in onLayout automatically
		...
		this.contentWidth = new Animated.Value(this.state.contentWidth); // will be changed in onLayout automatically
