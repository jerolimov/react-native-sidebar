...
import React, { Component, View, Animated, PanResponder, Text, TouchableOpacity } from 'react-native';
...
export default class SidebarView extends Component {
	...
	_handleShouldMove(event, gestureState) {
		...
		return this.openProgress._value !== 0 ||
				locationX >= 0 && locationX <= this.threshold ||
				locationX >= contentWidth - this.threshold && locationX <= contentWidth;
	}
